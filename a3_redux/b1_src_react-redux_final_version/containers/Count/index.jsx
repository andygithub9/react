...
class CountUI extends Component {
	...
	incrementIfOdd = () => {
		const { selectNum: { value } } = this;
		if ((this.props.myCount & 1) === 1) this.props.increment(value);
	};
	...
	render() {
		...
		return (
			<div>
				<h2>我是 Count 組件</h2>
				<h3>
					當前求和為: {this.props.myCount}, 下方 People 組件的總人數為: {this.props.NumberOfPeople}
				</h3>
...
export default connect(
	// 從 connect 函數的第一個參數可以得到 redux 的狀態的形參, 再通過返回一個對象{自定義 key: reduxState} 映射到 CountUI 的 props
	reduxState => ({ myCount: reduxState.countReducer, NumberOfPeople: reduxState.peopleReducer.length }),
