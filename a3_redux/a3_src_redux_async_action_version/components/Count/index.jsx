...
export default class Count extends Component {
	...
	incrementAsync = () => {
		...
		/* 
			...
			錯誤: Actions 必須是一個純對象。 但是你實際寫的卻是一個函數。
			你的 store 可能需要設置一個中間件來處理你 dispatch 的函數, 
			像是用 'redux-thunk' 來處理你 dispatch 的函數

			結論: 也就是要下載 'redux-thunk' 第三方庫並在 store 設置好才能處理 dispatch 一個函數
			thunk: 形實轉換程序 
		*/
		store.dispatch(createIncrementAsyncAction(+value, 500));
	};
